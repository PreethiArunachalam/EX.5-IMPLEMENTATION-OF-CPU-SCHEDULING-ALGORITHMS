...
Get the value for burst time of each process from the use.
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/0860505a-d0f6-41fd-b777-187819d050b9)
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/147d0122-ca8d-49fc-b2aa-a404a2da2366)
...
Start the process
Get the number of processes to be inserted
Get the corresponding priority of processes
Sort the processes according to the priority and allocate the one with highest priority to execute first
If two process have same priority then FCFS scheduling algorithm is used
Calculate the total and average waiting time and turnaround time
Display the values
Stop the process
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/f57b8623-2016-4238-9368-b3d47999302d)
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/85643600-f04e-4b88-954a-9f87a7fbeb93)
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/8aa91ce7-8e23-443c-9825-e5fa6f4b703b)
...
![image](https://github.com/PreethiArunachalam/EX.5-IMPLEMENTATION-OF-CPU-SCHEDULING-ALGORITHMS/assets/120115840/6bbd4818-a3d7-4a63-8859-5df24b36dfe1)
